...
public class ShotgunController : MonoBehaviour, IHandGrabUseDelegate
{
    ...
    private HapticClipPlayer playerL;
    private HapticClipPlayer playerR;
    ...
    private void Start()
    {
        playerL ??= new HapticClipPlayer(clip1);
        playerR ??= new HapticClipPlayer(clip1);
    }
    ...
    public void FireBullet()
    {
        ...
        if (muzzleFlashPrefab)
        {
            ...
            GameObject tempFlash = Instantiate(muzzleFlashPrefab, bulletSpawn.position,new Quaternion(bulletSpawn.rotation.x, bulletSpawn.rotation.y, bulletSpawn.rotation.z, bulletSpawn.rotation.w));
    ...
    {
        playerR.Play(Controller.Right);
        playerL.Play(Controller.Left);
    }
